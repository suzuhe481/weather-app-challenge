...
export const ClearDay = ({ className, style }: IIconProps) => {
  const id = useId();
...
export const MainlyClearDay = ({ className, style }: IIconProps) => {
  const id1 = useId();
  const id2 = useId();
...
export const MostlyCloudyDay = ({ className, style }: IIconProps) => {
  const id1 = useId();
  const id2 = useId();
...
export const PartlyCloudyDay = ({ className, style }: IIconProps) => {
  const id1 = useId();
  const id2 = useId();
...
export const HazeFogDustSmoke = ({ className, style }: IIconProps) => {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      fill="none"
...
export const Drizzle = ({ className, style }: IIconProps) => {
  const id = useId();
...
export const MixedRainSnow = ({ className, style }: IIconProps) => {
  const id = useId();
...
export const RainShowers = ({ className, style }: IIconProps) => {
  const id = useId();
...
export const HeavyRain = ({ className, style }: IIconProps) => {
  const id = useId();
...
export const Flurries = ({ className, style }: IIconProps) => {
  const id = useId();
...
export const SnowShowers = ({ className, style }: IIconProps) => {
  const id = useId();
...
export const HeavySnow = ({ className, style }: IIconProps) => {
  const id = useId();
...
export const Thunderstorms = ({ className, style }: IIconProps) => {
  const id1 = useId();
  const id2 = useId();
  const id3 = useId();
  const id4 = useId();
